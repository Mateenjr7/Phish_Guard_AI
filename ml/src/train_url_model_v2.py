...
# ==========================================
# REMOVE HTTPS FEATURE
# ==========================================

print("\nOriginal feature count:", X.shape[1])

if "IsHTTPS" in X.columns:
    X = X.drop(columns=["IsHTTPS"])

print("Feature count after removing IsHTTPS:", X.shape[1])
...
print("\n========================================")
print("      IMPROVED URL MODEL PERFORMANCE")
print("========================================")
